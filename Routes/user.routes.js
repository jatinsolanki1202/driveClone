...
router.post('/login', async (req, res) => {
    ...
    if (!user) {
        return res.render('../views/invalidCredToast', { message: 'Invalid email or password' });
    }

    bcrypt.compare(password, user.password, function (err, result) {
        if (!result) return res.render('../views/invalidCredToast', { message: 'Invalid email or password' });
